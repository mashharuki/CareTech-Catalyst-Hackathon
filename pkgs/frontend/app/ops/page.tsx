...
export default async function OpsPage() {
  ...
  const avgMs = totals.count > 0 ? Math.round(totals.weightedMs / totals.count) : 0;
  const successRate =
    totals.count > 0 ? Number(((totals.success / totals.count) * 100).toFixed(2)) : 0;
  ...
  return (
    <div className="mx-auto max-w-6xl p-6">
      <div className="mb-5 text-lg font-medium text-foreground">Ops Dashboard</div>
      ...
      <div className="mb-6 grid grid-cols-1 gap-4 sm:grid-cols-2">
        <div className="rounded-xl border border-border bg-card p-4">
          <div className="mb-2 text-sm font-medium text-foreground">Outbox Status</div>
        ...
        <div className="rounded-xl border border-border bg-card p-4">
          <div className="mb-2 text-sm font-medium text-foreground">Recent Audit</div>
